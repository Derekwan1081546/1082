...
void testCopyConstructor()
{
   ...
   for( unsigned int i = 0; i < number; i++ )
   {
      ...
      //cout << string1.myPtr() << " " << string2 << " " << string1.capacity() << " " << string2.capacity() << endl;
      string string3( string1 );
      std::string string4( string2 );
      //cout << string3.myPtr() << " " << string4 << " " << string3.capacity() << " " << string4.capacity() << endl;
...
bool equal( string &left, std::string &right )
{
    if (left.capacity() != right.capacity()) {
        //cout << "1  " << left.capacity() << "  " << right.capacity() << endl;
        return false;
    }
    if (left.size() != right.size()) {
        //cout << "2   " << left.size() << "  " << right.size() << endl;
        return false;
    }
